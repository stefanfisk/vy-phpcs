...
* GitHub Issues: <https://github.com/stefanfisk/vy-phpcs/issues>
...
* stefanfisk/vy-phpcs follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  stefanfisk/vy-phpcs automatically runs tests for pull requests. However,
...
[github]: https://github.com/stefanfisk/vy-phpcs
[issues]: https://github.com/stefanfisk/vy-phpcs/issues
[pull requests]: https://github.com/stefanfisk/vy-phpcs/pulls
